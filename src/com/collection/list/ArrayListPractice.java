...
public class ArrayListPractice {
	...
	public static void main(String[] args) {
		...
		System.out.println(listStud.get(1));
		...
		//System.out.println(listStud.indexOf()); cant give obj index
		
		//System.out.println(listStud.retainAll(listStud1));//listStud1 objects get deleted from listStud
		//System.out.println(listStud);
		
		//iterator
		/*
		 * Iterator iterator=listStud.iterator(); while(iterator.hasNext()) {
		 * System.out.println("listStud"+iterator.next());//returns next element in the
		 * iteration }
		 */
